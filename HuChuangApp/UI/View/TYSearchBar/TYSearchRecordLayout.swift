...
protocol TYSearchRecordLayoutDelegate: class {
    /// 单个cell的大小
...
class TYSearchRecordLayout: UICollectionViewFlowLayout {

    private var lastFrame: CGRect = .zero
    private var attributeArray: [UICollectionViewLayoutAttributes] = []
    
    public weak var layoutDelegate: TYSearchRecordLayoutDelegate?
